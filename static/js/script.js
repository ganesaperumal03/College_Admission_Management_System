$(document).ready(function(){
  ...
  function FillAddressInput()
    ...
    function hscvocSum() {
      ...
      var Twelfth_Std_voc_Practical_Mark = parseInt(document.getElementById("Twelfth_Std_voc_Practical_Mark").value) || 0;
      var Twelfth_Std_voc_Total_Marks = (Twelfth_Std_voc_Language_Mark + Twelfth_Std_voc_English_Mark + Twelfth_Std_voc_chemistry_Mark + Twelfth_Std_voc_Mathematics_or_Physics_Mark + Twelfth_Std_voc_Vocational_Theory_Mark + Twelfth_Std_voc_Practical_Mark) .toFixed(2) ;
      var Twelfth_Std_voc_CUT_OFF_Mark = ( Twelfth_Std_voc_chemistry_Mark + ((Twelfth_Std_voc_Mathematics_or_Physics_Mark + Twelfth_Std_voc_Vocational_Theory_Mark)/2)) .toFixed(2) ;
      var Twelfth_Std_voc_PCM_Average = (( Twelfth_Std_voc_chemistry_Mark + Twelfth_Std_voc_Mathematics_or_Physics_Mark + Twelfth_Std_voc_Vocational_Theory_Mark)/3 ) .toFixed(2) ;
    
      document.getElementById("Twelfth_Std_voc_Total_Marks").value = Twelfth_Std_voc_Total_Marks;
      document.getElementById("Twelfth_Std_voc_CUT_OFF_Mark").value = Twelfth_Std_voc_CUT_OFF_Mark;
      document.getElementById("Twelfth_Std_voc_PCM_Average").value = Twelfth_Std_voc_PCM_Average;
    }
