...
class HSC_Marks(models.Model):
    ...
    Twelfth_Std_Roll_No = models.CharField(max_length=20)
    ...
    Twelfth_Std_Register_No = models.CharField(max_length=20,blank=True,null=True)

    # 12th Std Academic Details Twelfth_Std_Register_No
...
class Preform_other_info(models.Model):
    ...
    diploma_certificate_no = models.CharField(max_length=50)
    diploma_studied_in = models.CharField(max_length=50, )
    sem1_total_mark = models.CharField(max_length=5,blank=True,null=True)
    sem1_obtain_mark = models.CharField(max_length=5,blank=True,null=True)
    sem2_total_mark = models.CharField(max_length=5,blank=True,null=True)
    sem2_obtain_mark = models.CharField(max_length=5,blank=True,null=True)
