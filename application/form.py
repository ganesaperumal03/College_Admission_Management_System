...
from .models import Personal_Details,HSC_Marks,Academic_Details,Diplomo,Preform_other_info,Preform
# forms.py
...
class Perform_sslc(forms.ModelForm):
    class Meta:
        ...
        fields = [ 'admissionNo','admissionFor', 'Tenth_Std_School_Name', 'Tenth_Std_Register_No','Tenth_Std_Medium_of_Study', 'Tenth_Std_Tamil_Name', 'Tenth_Std_Tamil_Mark','Tenth_Std_Tamil_Obtain_Mark', 'Tenth_Std_English_Name', 'Tenth_Std_English_Obtain_Mark'
        ,'Tenth_Std_Maths_Name', 'Tenth_Std_Maths_Mark', 'Tenth_Std_Science_Name','Tenth_Std_Science_Obtain_Mark','Tenth_Std_SocialScience_Name','Tenth_Std_SocialScience_Mark','Tenth_Std_SocialScience_Obtain_Mark','Tenth_Std_Others_Name','Tenth_Std_Others_Mark','Tenth_Std_Others_Obtain_Mark','Tenth_Std_Obtain_Mark',
         'Tenth_Std_Total_Mark','diploma', 'admissionNo', 'YEAR_OF_ADMISSION', 'Twelfth_Std_School_Name', 'Twelfth_Std_Year_of_Passing', 'Twelfth_Std_Place_of_School',
...
class Perform_declare(forms.ModelForm):
    class Meta:
        model = Preform
        fields = [ 'Branch_Preferrence_1', 'Branch_Preferrence_2', 'Physically_Challenged', 'Hostel_Required', 'First_Generation_Graduate', 'Quota']