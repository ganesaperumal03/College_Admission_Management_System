...
class AdmissionPersonal(forms.ModelForm):
    class Meta:
        ...
        fields = ['admissionNo', 'admissionFor', 'Quota','Department', 'Mode', 'Name','Date_of_Birth', 'Gender', 'Age'
        ,'Nationality', 'Religion', 'Mother_Tongue','Nativity', 'Self_Mobile_Number', 'Self_Email_ID','Father_name', 'Father_Mobile_Number', 'Mother_name','Mother_Mobile_Number', 'Guardian_name', 'Guardian_Father_Mobile_No'
        ,'Community', 'Caste', 'CommunityNumber','Aadhaar_Number']
        exclude = ['admissionNo'] 
