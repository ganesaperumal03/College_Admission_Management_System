...
def post_aca(request,admission_number):
    # Create an in-memory PDF file
    personal_details = get_object_or_404(Personal_Details, admissionNo=admission_number)
    hsc = HSC_Marks.objects.get(admissionNo=admission_number)
    academic = Academic_Details.objects.get(admissionNo=admission_number)
...
def post_voc(request,admission_number):
    # Create an in-memory PDF file
    personal_details = get_object_or_404(Personal_Details, admissionNo=admission_number)
    hsc = HSC_Marks.objects.get(admissionNo=admission_number)
    academic = Academic_Details.objects.get(admissionNo=admission_number)
...
def post_dip(request,admission_number):
    # Create an in-memory PDF file
    personal_details = get_object_or_404(Personal_Details, admissionNo=admission_number)
    diplomo = Diplomo.objects.get(admissionNo=admission_number)
    academic = Academic_Details.objects.get(admissionNo=admission_number)
    hsc = HSC_Marks.objects.get(admissionNo=admission_number)
...
def post_dip_aca(request,admission_number):
    # Create an in-memory PDF file
    personal_details = get_object_or_404(Personal_Details, admissionNo=admission_number)
    hsc = HSC_Marks.objects.get(admissionNo=admission_number)
    academic = Academic_Details.objects.get(admissionNo=admission_number)
...
def post_dip_voc(request,admission_number):
    # Create an in-memory PDF file
    personal_details = get_object_or_404(Personal_Details, admissionNo=admission_number)
    hsc = HSC_Marks.objects.get(admissionNo=admission_number)
    academic = Academic_Details.objects.get(admissionNo=admission_number)
