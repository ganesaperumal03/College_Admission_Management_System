...
$pdf->Cell(35, 5, $row_data2["Twelfth_Std_aca_Language_Mark"], 1, 0, 'C');

//English
$pdf->SetXY(30,235);
$pdf->Cell(35, 5, "English", 1, 0, 'C');
$pdf->Cell(35, 5, $row_data2["Twelfth_Std_aca_English_Mark"], 1, 0, 'C');

//Mathematics
$pdf->SetXY(30,240);
$pdf->Cell(35, 5, "Mathematics", 1, 0, 'C');
$pdf->Cell(35, 5, $row_data2["Twelfth_Std_aca_Mathematics_Mark"], 1, 0, 'C');

//Physics
$pdf->SetXY(30,245);
$pdf->Cell(35, 5, "Physics", 1, 0, 'C');
$pdf->Cell(35, 5, $row_data2["Twelfth_Std_aca_Physics_Mark"], 1, 0, 'C');

//Chemistry
$pdf->SetXY(30,250);
$pdf->Cell(35, 5, "Chemistry", 1, 0, 'C');
$pdf->Cell(35, 5, $row_data2["Twelfth_Std_aca_Chemistry_Mark"], 1, 0, 'C');

//Elective Marks
$pdf->SetXY(30,255);
$pdf->Cell(35, 5, $row_data2["Twelfth_Std_aca_Elective_Name"], 1, 0, 'C');
$pdf->Cell(35, 5, $row_data2["Twelfth_Std_aca_Elective_Mark"], 1, 0, 'C');
...
//Total
$pdf->SetXY(30,260);
$pdf->Cell(26, 5, "Total : " . $row_data2["Twelfth_Std_aca_Total_Marks"] . " out of 600", 1, 0, 'C', true);

//Cut Off
$pdf->Cell(18, 5, "Cut Off : " . $row_data2["Twelfth_Std_aca_CUT_OFF_Mark"], 1, 0, 'C', true);

//PCM Average
$pdf->Cell(26, 5, "PCM Average : " . $row_data2["Twelfth_Std_aca_PCM_Average"] . " %", 1, 0, 'C', true);
